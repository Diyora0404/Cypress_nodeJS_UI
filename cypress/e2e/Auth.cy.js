describe('Auth',  () =>{
    ...
    it('Sign in with valid credentials', ()=>{
        cy.get('#normal_login_email').type('diyoraabd04@gmail.com')
        cy.get('#normal_login_password').type('job0404di')
    ...
    it('Validation of the fields for Sing in', ()=>{
        ...
        cy.get('#normal_login_email_help').should('have.text', '\'email\' is not a valid email')
            .should('be.visible')
        cy.get('.login-form-button').should('be.disabled')
        ...
        cy.get('#normal_login_email_help').should('have.text', 'Required')
            .should('be.visible')
        cy.get('.login-form-button').should('be.disabled')
        ...
        cy.get('#normal_login_password_help').should('have.text', 'Required')
            .should('be.visible')
        cy.get('.login-form-button').should('be.disabled')
    })
})
